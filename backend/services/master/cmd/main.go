...
import (
	...
	"github.com/boreas/backend/services/master/internal/config"
	"github.com/boreas/backend/services/master/internal/database"
	"github.com/boreas/backend/services/master/internal/handler"
	"github.com/boreas/backend/services/master/internal/logger"
	"github.com/boreas/backend/services/master/internal/middleware"
	"github.com/boreas/backend/services/master/internal/repository/postgres"
	"github.com/boreas/backend/services/master/internal/service"
	"github.com/boreas/backend/services/master/internal/utils"
...
func main() {
	...
	// 启动服务器
	go func() {
		logger.GetLogger().Info("Starting master service",
