...
import (
	...
	"github.com/boreas/backend/services/operator/internal/config"
	"github.com/boreas/backend/services/operator/internal/database"
	"github.com/boreas/backend/services/operator/internal/logger"
	"github.com/boreas/backend/services/operator/internal/middleware"
...
func main() {
	...
	// 启动服务器
	go func() {
		logger.GetLogger().Info("Starting operator service",
